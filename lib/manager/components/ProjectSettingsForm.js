  ...
  render () {
    ...
    return (
      <div>
        ...
        <Panel>
          <Panel.Heading><Panel.Title componentClass='h4'>Shared Stops</Panel.Title></Panel.Heading>
          <ListGroup>
            <ListGroupItem>
              <FormGroup>
                {/* TODO: on enter, textarea should NOT submit */}
                {/* TODO: Validate CSV? */}
                <FormControl
                  name={'sharedStopsConfig'}
                  onChange={this._onChangeTextInput}
                  value={model.sharedStopsConfig || ''}
                  style={{height: model.sharedStopsConfig ? 200 : 150}}
