...
![pattern-toolbar](https://datatools-builds.s3.amazonaws.com/docs/patterns/pattern-toolbar.png)
...
![pattern-add-stop](https://datatools-builds.s3.amazonaws.com/docs/patterns/pattern-add-stop.png)
...
![pattern-insert-stop](https://datatools-builds.s3.amazonaws.com/docs/patterns/pattern-insert-stop.png)
...
![pattern-stop-order](https://datatools-builds.s3.amazonaws.com/docs/patterns/pattern-stop-order.png)
...
![pattern-shape-panel](https://datatools-builds.s3.amazonaws.com/docs/patterns/pattern-shape-panel.png)
